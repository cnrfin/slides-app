...
// Initialize language attributes on store creation
const initializeLanguageAttributes = (language: LanguageCode) => {
...
const useLanguageStore = create<LanguageStore>()(
  persist(
    (set, get) => {
      ...
      const initialLanguage = (i18n.language as LanguageCode) || 'en';
      
      // Apply initial language attributes immediately
      ...
      return {
        ...
        setLanguage: (language) => {
          ...
          initializeLanguageAttributes(language);
        },
