// src/services/googleDriveSimpleFix.ts
// Fixed version of Google Drive service with proper upsert handling
...
class GoogleDriveSimpleServiceFixed {
      ...
      return new Promise((resolve) => {
        ...
        this.tokenClient.callback = async (response: any) => {
          ...
          try {
            ...
            // Save connection info to database with proper conflict handling
  ...
  /**
   * Save token info with proper conflict handling
   */
...
export const googleDriveSimpleFixed = new GoogleDriveSimpleServiceFixed();